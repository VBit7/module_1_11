"""
Для екземпляра класу Vector реалізуйте функтор.
Створіть для класу Vector метод __call__.
...
vector_1 = Vector(Point(1, 10))
print(vector_1())  # (1, 10)

vector_2 = Vector(Point(1, 10))
print(vector_2(5))  # (5, 50)